...
| 3–4 | เริ่มเป็นตัวเอง แต่ยังลังเล | The Fool (0) | มีความอยากรู้อยากเห็น กำลังค้นพบตัวเองอย่างสดใหม่ | ยังไม่มั่นคงพอ อาจถูกสั่นคลอนได้ง่ายจากความคิดเห็นคนอื่น |
...
| 7–8 | เริ่มซ่อนตัว ปรับตามคนอื่น | The Moon (18) | อ่านห้องเก่ง ไม่สร้างความขัดแย้ง คนรอบข้างสบายใจ | เริ่มสูญเสียเสียงของตัวเอง ทำตามคนอื่นจนลืมว่าตัวเองอยากได้อะไร |
...
| 9–10 | เสียสละจน lose self โดยไม่รู้ตัว | The Moon (18) | เป็นที่พึ่งของทุกคน ครอบครัวรู้สึกมั่นคงเพราะมีเรา | ไม่รู้แล้วว่าตัวเองต้องการอะไร ชีวิตถูกนิยามโดยหน้าที่ ไม่ใช่ความต้องการ |
...
| 7–8 | เริ่มระวังตัว ตั้งการ์ด | The Moon (18) | ไม่เจ็บง่าย รู้จักสังเกตและรอให้มั่นใจก่อน | อาจทำให้คนที่รักรู้สึกว่าเข้าถึงไม่ได้ ความสัมพันธ์เดินหน้าช้า |
