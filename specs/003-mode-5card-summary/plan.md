...
#### การเงิน — Spectrum: A = ใช้/ลงทุน/เชื่อความอุดมสมบูรณ์ → B = เก็บ/ระวัง/กลัวขาดแคลน

| Score | ความหมาย | ไพ่แนะนำ | ข้อดี | ข้อเสีย |
|-------|----------|-----------|--------|---------|
| 0–2 | ใช้คล่อง กล้าเสี่ยง อาจ overspend | The Sun (19) | เชื่อในความอุดมสมบูรณ์ ใช้เงินเป็นเครื่องมือสร้างชีวิต ไม่กลัวเงินหมด | อาจใช้เกินตัว ไม่มีเบาะรองรับยามฉุกเฉิน เสี่ยงโดยไม่คำนวณพอ |
| 3–4 | กล้าลงทุน มีทิศทางชัด | The Magician (1) | ลงมือสร้างความมั่งคั่งเอง ไม่นั่งรอโชค รู้จักใช้ทรัพยากรที่มีอย่างชาญฉลาด | อาจมั่นใจในแผนตัวเองเกินไป ประเมินความเสี่ยงต่ำกว่าความเป็นจริง |
| 5–6 | สมดุล รู้จักใช้และเก็บ | The Wheel (10) | เข้าใจจังหวะของเงิน รู้ว่าเมื่อไหรควรใช้และเมื่อไหรควรเก็บ | บางครั้งพึ่งพาโชคหรือจังหวะมากเกินไป แทนที่จะวางแผนระยะยาว |
| 7–8 | ระวังมาก ชอบเก็บออม | The Emperor (4) | มีวินัยทางการเงินสูง วางแผนละเอียด มีเงินสำรองเสมอ | อาจแข็งเกินไปจนพลาดโอกาสลงทุนที่ดี หรือไม่ยอมใช้เงินเพื่อคุณภาพชีวิต |
| 9–10 | over-control กลัวขาดแคลน | Justice (11) | ทุกบาทมีเหตุผล ไม่เสียเงินฟุ่มเฟือย ปลอดภัยทางการเงินสูงมาก | ความกลัวขาดแคลนควบคุมชีวิต ไม่กล้าใช้เงินแม้แต่กับตัวเองหรือสิ่งที่มีความหมาย |

**outcomes: [19, 1, 10, 4, 11]**
